...
import { FileText, PlusCircle, Search, Image } from "lucide-react";
...
interface ManageExamsProps {
  ...
  SEMESTERS: string[];
  SUBJECTS: string[];
  getExamsForTeacher: (teacherId: string) => Promise<any[]>;
  isCreateExamDialogOpen: boolean;
  setIsCreateExamDialogOpen: (open: boolean) => void;
  examTitle: string;
  setExamTitle: (title: string) => void;
  examSubject: string;
  setExamSubject: (subject: string) => void;
  examSemester: string;
  setExamSemester: (semester: string) => void;
  examDuration: string;
  setExamDuration: (duration: string) => void;
  examDate: string;
  ...
  examSections: any[];
  setExamSections: (sections: any[]) => void;
  currentSection: string;
  setCurrentSection: (section: string) => void;
  handleStudentSelection: (studentId: string) => void;
  students: any[];
  selectedSemester: string;
  handleSelectAllStudents: (semesterFilter: string) => void;
  createExam: (examData: Omit<any, "id">) => Promise<any>;
}
...
export function ManageExams({
  ...
  SUBJECTS,
  getExamsForTeacher,
  isCreateExamDialogOpen,
  setIsCreateExamDialogOpen,
  examTitle,
  setExamTitle,
  examSubject,
  setExamSubject,
